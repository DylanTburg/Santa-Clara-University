...
exti5_init	PROC		;initialize the external interrupt detector for PA.5
		...
		str		r1,[r2]		
		ldr		r2,=(SYSCFG_BASE+SYSCFG_EXTICR1)	;select PA.5 and the trigger for EXTI5
		ldr		r1,[r2]
		bic		r1,#0x00000070						
		str		r1,[r2]
		ldr		r2,=(EXTI_BASE+EXTI_RTSR1)	;enable rising edge trigger for EXTI5		
		ldr		r1,[r2]
		...
		str		r1,[r2]	
		ldr		r2,=(NVIC_BASE+NVIC_ISER0)	;enable the EXTI5 interrupt in NVIC_ISER0
		ldr		r1,=(1<<23)
		str		r1,[r2]
		bx		lr	
		ENDP
