...
exti0_init	PROC		;initialize the external interrupt detector for PA.3
		...
		str		r1,[r2]		
		ldr		r2,=(SYSCFG_BASE+SYSCFG_EXTICR0)	;select PA.3 and the trigger for EXTI0
		ldr		r1,[r2]
		bic		r1,#0x00000007						;This is the default anyway
		str		r1,[r2]
		...
		ldr		r1,[r2]
		bic		r1,#EXTI_FTSR1_FT0			;also the default
		str		r1,[r2]
